...
export const deInstrumentTranslations = {
    ...
    "scales": {
        "quantity": {
            ...
            "description": "Menge bezieht sich darauf, wie viele spezifische Angebote oder Umgebungsmerkmale verfügbar sind.",
            "options": {
                "no": {
                    "label": "Nein"
                },
        ...
        "diversity": {
            ...
            "description": "Vielfalt bewertet, ob die bereitgestellten Elemente abwechslungsreich sind oder alle gleich sind.",
            "options": {
                "not_applicable": {
                    "label": "Nicht zutreffend"
                },
        ...
        "sociability": {
            ...
            "description": "Sozialität berücksichtigt, ob die Funktion allein, zu zweit oder in größeren Gruppen genutzt werden kann.",
            "options": {
                "not_applicable": {
                    "label": "Nicht zutreffend"
                },
        ...
        "challenge": {
            ...
            "description": "Herausforderung bewertet, ob die Funktion Möglichkeiten mit unterschiedlichen Schwierigkeitsgraden bietet.",
            "options": {
                "not_applicable": {
                    "label": "Nicht zutreffend"
                },
    ...
    "sections": {
        ...
        "section_2_playspace_location_connectivity": {
            ...
            "description": "Lage & Anbindung des Spielbereichs beschreibt, wie der Spielbereich in das Umfeld eingebettet ist, ob weitere Spiel- und Freizeitmöglichkeiten vorhanden sind und wie Nutzerinnen und Nutzer den Spielbereich erreichen.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Lage und Anbindung dieses Spielbereichs:",
            "questions": {
                "q_2_1": {
        ...
        "section_3_playspace_rules_restrictions": {
            ...
            "description": "Regeln & Einschränkungen im Spielbereich bewertet, ob Regeln und Einschränkungen das Spielen im Freien behindern.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Regeln und Einschränkungen dieses Spielbereichs:",
            "questions": {
                "q_3_1": {
        ...
        "section_4_playspace_information_wayfinding": {
            ...
            "description": "Information & Orientierung im Spielbereich bieten Orientierung im Spielbereich, Informationen dazu, wie man sich im Spielbereich zurechtfindet, und/oder Hinweise dazu, was zu tun ist oder wie der Spielplatz genutzt werden soll.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Information und Orientierung dieses Spielbereichs:",
            "questions": {
                "q_4_1": {
        ...
        "section_5_management_maintenance": {
            ...
            "description": "Betrieb und Instandhaltung umfassen Aspekte, die eine sichere und bespielbare Umgebung gewährleisten.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung des Betriebs und der Instandhaltung dieses Spielbereichs:",
            "questions": {
                "q_5_1": {
        ...
        "section_6_climate_protection_adaptability": {
            ...
            "description": "??",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Wege in diesem Spielbereich:",
            "questions": {
                "q_6_1": {
        ...
        "section_9_open_space": {
            "title": "Offene Fläche",
            "description": "Eine offene Fläche ist ein integrierter Bereich innerhalb oder um den Spielbereich herum ohne Spielelemente, andere bauliche Strukturen und ohne Bepflanzung. Offene Flächen sind Mehrzweckbereiche und werden flexibel genutzt; sie bieten vielfältige Möglichkeiten wie Laufen, Gehen, Spielen mit losen Teilen (Bälle, Hula-Hoops oder natürliche Elemente und andere), Sitzen oder Entspannen, Picknicks, Gruppenspiele, …",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der offenen Flächen dieses Spielbereichs:",
            "questions": {
                "q_9_1": {
        ...
        "section_11_sport_game_spaces": {
            ...
            "description": "Sport- und Spielflächen sind abgegrenzte Bereiche, die Kindern eine bestimmte Art von Spiel ermöglichen, z. B. Fußball, Basketball und (Tisch-)Tennis. Diese Sport- und Spielflächen sind manchmal vom Spielplatz getrennt. Wenn Sportflächen nahe liegen oder in den Spielplatz integriert sind, nehmen Sie sie in die Bewertung auf.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielraum...",
            "notesPrompt": "Kommentare? Beschreiben Sie eine oder mehrere Empfehlungen, um die Sport- und Spielflächen dieses Spielraums zu verbessern:",
            "questions": {
                "q_11_1": {
        ...
        "section_12_manufactured_play_features": {
            ...
            "description": "Künstlich hergestellte Spielelemente sind für das Spielen hergestellte Elemente, die auch als Spielgeräte oder Spielkomponenten bezeichnet werden. Sie können aus unterschiedlichen Materialien wie Kunststoff, Metall oder Holz hergestellt sein.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielraum...",
            "notesPrompt": "Kommentare? Beschreiben Sie eine oder mehrere Empfehlungen, um die künstlich hergestellten Spielelemente dieses Spielraums zu verbessern:",
            "questions": {
                "q_12_1": {
        ...
        "section_14_loose_manufactured_parts_equipment": {
            ...
            "description": "Lose hergestellte Teile & Geräte sind von Menschen hergestellte Spielobjekte, die manchmal auf dem Spielplatz bereitgestellt werden, manchmal aber auch mitgebracht werden (z. B. lose geformte lose Teile, Kettcars, Roller, Fahrräder, Bälle/Frisbees oder anderes Spielzeug, Sand-/Matsch-/Wasserspielzeug)",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielraum...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der losen hergestellten Teile und Geräte dieses Spielraums:",
            "questions": {
                "q_14_1": {
        ...
        "section_17_amenities": {
            "title": "Ausstattung",
            "description": "Ausstattung sind unterstützende Elemente eines Spielplatzes, die dazu beitragen, den Spielplatz besonders für Familien, Kinder mit Behinderungen und Mädchen attraktiver und komfortabler zu machen.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Ausstattung dieses Spielbereichs:",
            "questions": {
                "q_17_1": {
        ...
        "section_18_topography_surfaces": {
            ...
            "description": "Topografie & Oberflächen umfassen Hügel, Hänge, Vertiefungen und Stufen im Gelände. Sie ermöglichen vielfältige Spielformen wie Rennen, Hinunterrollen, Gegenstände hinunterrollen lassen, Fahren, Klettern, Balancieren, Rodeln, Rutschen, das Genießen von Ausblicken und das Erleben von Höhen, Springen/Tauchen/Rollen in/über Pfützen, …)",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Topografie und Oberflächen dieses Spielbereichs:",
            "questions": {
                "q_18_1": {
        ...
        "section_19_novelty": {
            ...
            "description": "???",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen zur Verbesserung der Neuartigkeit dieses Spielbereichs:",
            "questions": {
                "q_19_1": {
        ...
        "section_22_playspace_suitability_for_diverse_users": {
            ...
            "description": "Die Eignung des Spielbereichs für unterschiedliche Nutzergruppen bewertet, wie gut der Spielbereich darauf ausgelegt ist, die Bedürfnisse von Kindern unterschiedlichen Alters und mit verschiedenen Fähigkeiten zu erfüllen.",
            "instruction": "Lesen Sie jede Aussage und beantworten Sie die Fragen. Dieser Spielbereich...",
            "notesPrompt": "Anmerkungen? Beschreiben Sie eine oder mehrere Empfehlungen, um diesen Spielbereich für unterschiedliche Altersgruppen und Fähigkeiten zu verbessern.",
            "questions": {
                "q_22_1": {
