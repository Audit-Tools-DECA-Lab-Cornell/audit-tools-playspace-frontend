	...
	return (
		<TabsPrimitive.Trigger
			...
			className={cn(
				...
				"data-[state=active]:bg-surface-raised data-[state=active]:text-foreground dark:data-[state=active]:border-border dark:data-[state=active]:bg-surface-raised dark:data-[state=active]:text-foreground",
